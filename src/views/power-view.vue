...
<script setup>
import { ref } from "vue";
import PieEcharts from "../components/leftTop.vue"//左上
import LineEcharts from "../components/leftBottom.vue"//左下
import BarEcharts from "../components/rightMiddle.vue"//右中
import RightBottomSvg from "../components/rightBottom.vue"//右下
import CenterSvg from "../components/centerTop.vue"//中上
import BottomPanel from "../components/centerBottom.vue"//中下
import RightTopPanel from "../components/rightTop.vue"//右上
...
/*
getPowerScreenData().then(res => {
  chargingPile.value = res.data.chargingPile
  processMonitoring.value = res.data.processMonitoring
  chargingStatistics.value = res.data.chargingStatistics
  exceptionMonitoring.value = res.data.exceptionMonitoring
  dataAnalysis.value = res.data.dataAnalysis
  chargingTop4.value = res.data.chargingTop4
  percentage.value = res.data.chargingTop4
})
*/
